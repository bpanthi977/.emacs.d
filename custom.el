(custom-set-variables 
 ...
 '(org-agenda-files
   (quote
    ("~/Documents/synced/BE/Corona Time/SD/paper.org" "~/Documents/synced/BE/Corona Time/SD/20200601092054-sd.org" "~/org/ms/manuscript.org" "~/org/notes.org" "~/org/tasks.org" "~/org/programming.org")))
 ...
 '(safe-local-variable-values
   (quote
    ((bibtex-completion-bibliography . "/mnt/Data/Documents/synced/BE/Corona Time/LCT/references.bib")
     ...
     (bibtex-completion-notes-path . "/home/bpanthi/Documents/synced/BE/Corona Time/SD/notes.org")
     (org-ref-bibliography-notes . "/home/bpanthi/Documents/synced/BE/Corona Time/SD/notes.org")
     (bibtex-completion-library-path . "/home/bpanthi/Documents/synced/BE/Corona Time/SD/papers/")
     (org-ref-pdf-directory . "/home/bpanthi/Documents/synced/BE/Corona Time/SD/papers/")
     (org-roam-directory . "~/Documents/synced/BE/Corona Time/SD/")
     (org-roam-db-location . "~/Documents/synced/BE/Corona Time/SD/org-roam-l.db")
     (bibtex-completion-bibliography . "~/Documents/synced/BE/Corona Time/SD/references.bib")
     (org-ref-default-bibliography . "~/Documents/synced/BE/Corona Time/SD/references.bib")
     (bibtex-completion-notes-path . "~/Documents/synced/BE/Corona Time/SD/notes.org")
     (org-ref-bibliography-notes . "~/Documents/synced/BE/Corona Time/SD/notes.org")
     (bibtex-completion-library-path . "~/Documents/synced/BE/Corona Time/SD/papers/")
     (org-ref-pdf-directory . "~/Documents/synced/BE/Corona Time/SD/papers/")
     (Package ITERATE :use "COMMON-LISP" :colon-mode :external)
     (syntax . COMMON-LISP)
     (whitespace-style quote
		       (face trailing empty tabs))
     (whitespace-action)
     (Package . metabang\.math)
     (org-roam-db-location . "/mnt/Data/Documents/synced/BE/Corona Time/SD/org-roam.db")
     (org-roam-directory . "/mnt/Data/Documents/synced/BE/Corona Time/SD")
     (org-roam-db-location . "/mnt/Data/Documents/synced/BE/Corona Time/LCT/database/roam.db")
     (org-roam-directory . "/mnt/Data/Documents/synced/BE/Corona Time/LCT")
     (org-roam-db-location . "~/Documents/synced/BE/Corona Time/LCT/database/roam.db")
     (org-roam-db-location . "~/Documents/synced/BE/Corona Time/LCT/database/")
     (eval text-scale-set 3)
     (eval setq text-scale-mode-amount 3)
     (text-scale-mode-amount . 3)
     (text-scale-mode-step . 3)
     (Syntax . ANSI-Common-Lisp)
     (Base . 10)
     (org-roam-db-location . "~/Documents/synced/BE/Corona Time/SD/org-roam.db")
     (org-roam-db-location . "~/Documents/synced/BE/Corona Time/SD/")
     (org-roam-directory . "~/Documents/synced/BE/Corona Time/SD")
...
;;      (projectile-project-compilation-cmd . "BROWSER=none yarn start")
;;      (projectile-project-compilation-cmd . "yarn start")
;;      (projectile-project-compile-cmd . "yarn start")
;;      (projectile-project-run-cmd . "yarn electron .")
;;      (projectile-project-test-cmd . "yarn test")
;;      (projectile-project-run-cmd . "yarn electron-dev")
;;      (eval put
;; 	   (quote test-js-eval)
